...
int main(int agrc, char **agrv)
{
    ...
    for (k = 0; k < Nb; k++)
    {
            ...
            for (j = end_column; j < K; j += 4)
            {
                ...
                for (i = 0; i < block_size - 1; i++)
                {
                    for (l = 0; l < block_size - 1; l++)
                    {
                        ...
                        AK[i + start_row_pink + 1][j + 1] -= di[i][l] * AK[start_row_pink + l][j + 1];
                        AK[i + start_row_pink + 1][j + 2] -= di[i][l] * AK[start_row_pink + l][j + 2];
                        AK[i + start_row_pink + 1][j + 3] -= di[i][l] * AK[start_row_pink + l][j + 3];
                    }
        ...
        if (myid <= (k % numprocs))
        {
            ...
            for (j = end_row; j < M; j += 4)
            {
                for (i = end_column; i < K; i += 4)
                {

                    AK[j][i] -= AW[j][0] * AK[start_row + 0][i] + AW[j][1] * AK[start_row + 1][i] + AW[j][2] * AK[start_row + 2][i] + AW[j][3] * AK[start_row + 3][i] + AW[j][4] * AK[start_row + 4][i] + AW[j][5] * AK[start_row + 5][i] + AW[j][6] * AK[start_row + 6][i] + AW[j][7] * AK[start_row + 7][i];
                    AK[j][i + 1] -= AW[j][0] * AK[start_row + 0][i + 1] + AW[j][1] * AK[start_row + 1][i + 1] + AW[j][2] * AK[start_row + 2][i + 1] + AW[j][3] * AK[start_row + 3][i + 1] + AW[j][4] * AK[start_row + 4][i + 1] + AW[j][5] * AK[start_row + 5][i + 1] + AW[j][6] * AK[start_row + 6][i + 1] + AW[j][7] * AK[start_row + 7][i + 1];

                    AK[j][i + 2] -= AW[j][0] * AK[start_row + 0][i + 2] + AW[j][1] * AK[start_row + 1][i + 2] + AW[j][2] * AK[start_row + 2][i + 2] + AW[j][3] * AK[start_row + 3][i + 2] + AW[j][4] * AK[start_row + 4][i + 2] + AW[j][5] * AK[start_row + 5][i + 2] + AW[j][6] * AK[start_row + 6][i + 2] + AW[j][7] * AK[start_row + 7][i + 2];

                    AK[j][i + 3] -= AW[j][0] * AK[start_row + 0][i + 3] + AW[j][1] * AK[start_row + 1][i + 3] + AW[j][2] * AK[start_row + 2][i + 3] + AW[j][3] * AK[start_row + 3][i + 3] + AW[j][4] * AK[start_row + 4][i + 3] + AW[j][5] * AK[start_row + 5][i + 3] + AW[j][6] * AK[start_row + 6][i + 3] + AW[j][7] * AK[start_row + 7][i + 3];

                    AK[j + 1][i] -= AW[j + 1][0] * AK[start_row + 0][i] + AW[j + 1][1] * AK[start_row + 1][i] + AW[j + 1][2] * AK[start_row + 2][i] + AW[j + 1][3] * AK[start_row + 3][i] + AW[j + 1][4] * AK[start_row + 4][i] + AW[j + 1][5] * AK[start_row + 5][i] + AW[j + 1][6] * AK[start_row + 6][i] + AW[j + 1][7] * AK[start_row + 7][i];

                    AK[j + 1][i + 1] -= AW[j + 1][0] * AK[start_row + 0][i + 1] + AW[j + 1][1] * AK[start_row + 1][i + 1] + AW[j + 1][2] * AK[start_row + 2][i + 1] + AW[j + 1][3] * AK[start_row + 3][i + 1] + AW[j + 1][4] * AK[start_row + 4][i + 1] + AW[j + 1][5] * AK[start_row + 5][i + 1] + AW[j + 1][6] * AK[start_row + 6][i + 1] + AW[j + 1][7] * AK[start_row + 7][i + 1];

                    AK[j + 1][i + 2] -= AW[j + 1][0] * AK[start_row + 0][i + 2] + AW[j + 1][1] * AK[start_row + 1][i + 2] + AW[j + 1][2] * AK[start_row + 2][i + 2] + AW[j + 1][3] * AK[start_row + 3][i + 2] + AW[j + 1][4] * AK[start_row + 4][i + 2] + AW[j + 1][5] * AK[start_row + 5][i + 2] + AW[j + 1][6] * AK[start_row + 6][i + 2] + AW[j + 1][7] * AK[start_row + 7][i + 2];

                    AK[j + 1][i + 3] -= AW[j + 1][0] * AK[start_row + 0][i + 3] + AW[j + 1][1] * AK[start_row + 1][i + 3] + AW[j + 1][2] * AK[start_row + 2][i + 3] + AW[j + 1][3] * AK[start_row + 3][i + 3] + AW[j + 1][4] * AK[start_row + 4][i + 3] + AW[j + 1][5] * AK[start_row + 5][i + 3] + AW[j + 1][6] * AK[start_row + 6][i + 3] + AW[j + 1][7] * AK[start_row + 7][i + 3];

                    AK[j + 2][i] -= AW[j + 2][0] * AK[start_row + 0][i] + AW[j + 2][1] * AK[start_row + 1][i] + AW[j + 2][2] * AK[start_row + 2][i] + AW[j + 2][3] * AK[start_row + 3][i] + AW[j + 2][4] * AK[start_row + 4][i] + AW[j + 2][5] * AK[start_row + 5][i] + AW[j + 2][6] * AK[start_row + 6][i] + AW[j + 2][7] * AK[start_row + 7][i];

                    AK[j + 2][i + 1] -= AW[j + 2][0] * AK[start_row + 0][i + 1] + AW[j + 2][1] * AK[start_row + 1][i + 1] + AW[j + 2][2] * AK[start_row + 2][i + 1] + AW[j + 2][3] * AK[start_row + 3][i + 1] + AW[j + 2][4] * AK[start_row + 4][i + 1] + AW[j + 2][5] * AK[start_row + 5][i + 1] + AW[j + 2][6] * AK[start_row + 6][i + 1] + AW[j + 2][7] * AK[start_row + 7][i + 1];

                    AK[j + 2][i + 2] -= AW[j + 2][0] * AK[start_row + 0][i + 2] + AW[j + 2][1] * AK[start_row + 1][i + 2] + AW[j + 2][2] * AK[start_row + 2][i + 2] + AW[j + 2][3] * AK[start_row + 3][i + 2] + AW[j + 2][4] * AK[start_row + 4][i + 2] + AW[j + 2][5] * AK[start_row + 5][i + 2] + AW[j + 2][6] * AK[start_row + 6][i + 2] + AW[j + 2][7] * AK[start_row + 7][i + 2];

                    AK[j + 2][i + 3] -= AW[j + 2][0] * AK[start_row + 0][i + 3] + AW[j + 2][1] * AK[start_row + 1][i + 3] + AW[j + 2][2] * AK[start_row + 2][i + 3] + AW[j + 2][3] * AK[start_row + 3][i + 3] + AW[j + 2][4] * AK[start_row + 4][i + 3] + AW[j + 2][5] * AK[start_row + 5][i + 3] + AW[j + 2][6] * AK[start_row + 6][i + 3] + AW[j + 2][7] * AK[start_row + 7][i + 3];

                    AK[j + 3][i] -= AW[j + 3][0] * AK[start_row + 0][i] + AW[j + 3][1] * AK[start_row + 1][i] + AW[j + 3][2] * AK[start_row + 2][i] + AW[j + 3][3] * AK[start_row + 3][i] + AW[j + 3][4] * AK[start_row + 4][i] + AW[j + 3][5] * AK[start_row + 5][i] + AW[j + 3][6] * AK[start_row + 6][i] + AW[j + 3][7] * AK[start_row + 7][i];

                    AK[j + 3][i + 1] -= AW[j + 3][0] * AK[start_row + 0][i + 1] + AW[j + 3][1] * AK[start_row + 1][i + 1] + AW[j + 3][2] * AK[start_row + 2][i + 1] + AW[j + 3][3] * AK[start_row + 3][i + 1] + AW[j + 3][4] * AK[start_row + 4][i + 1] + AW[j + 3][5] * AK[start_row + 5][i + 1] + AW[j + 3][6] * AK[start_row + 6][i + 1] + AW[j + 3][7] * AK[start_row + 7][i + 1];

                    AK[j + 3][i + 2] -= AW[j + 3][0] * AK[start_row + 0][i + 2] + AW[j + 3][1] * AK[start_row + 1][i + 2] + AW[j + 3][2] * AK[start_row + 2][i + 2] + AW[j + 3][3] * AK[start_row + 3][i + 2] + AW[j + 3][4] * AK[start_row + 4][i + 2] + AW[j + 3][5] * AK[start_row + 5][i + 2] + AW[j + 3][6] * AK[start_row + 6][i + 2] + AW[j + 3][7] * AK[start_row + 7][i + 2];

                    AK[j + 3][i + 3] -= AW[j + 3][0] * AK[start_row + 0][i + 3] + AW[j + 3][1] * AK[start_row + 1][i + 3] + AW[j + 3][2] * AK[start_row + 2][i + 3] + AW[j + 3][3] * AK[start_row + 3][i + 3] + AW[j + 3][4] * AK[start_row + 4][i + 3] + AW[j + 3][5] * AK[start_row + 5][i + 3] + AW[j + 3][6] * AK[start_row + 6][i + 3] + AW[j + 3][7] * AK[start_row + 7][i + 3];
